...
const ProductTabSection = ({
  ...
  useEffect(() => {
    const fetchSubCategories = async () => {
      ...
      try {
        const result =
          await categoryController.getSubCategoriesByCategory(categoryId);
        if (result.success) {
  ...
  return (
    <div className="section-product-tabs mt-xl-5 mt-md-4  mt-3">
      <div className="container">
        ...
        <div className="heading-tabs mt-xl-4 mt-md-3 mt-2 mx-lg-5 mx-md-4 mt-md-1 mx-2 row flex-nowrap overflow-auto overflow-md-visible justify-content-md-center">
          {subCategories.slice(0, 3).map((sub) => (
            <button
              key={sub._id}
              className={`btn product-tab col-xl-3 col-md-3 col-6 mx-xl-3 mx-md-2 mx-1 ${
